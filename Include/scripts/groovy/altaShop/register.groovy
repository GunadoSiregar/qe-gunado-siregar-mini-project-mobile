...
class register {
	...
	def inputCredentials(String Fullname, String Email, String Password) {
		println("Fullname :" + Fullname)
		println("Email : " + Email)
		println("Password : " + Password)

		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Alex Under, Fullname (1)'), 'Gunado Siregar', 0)

		Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email'), 0)

		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email (1)'), 'bursar@gmail.com', 0)

		Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password'), 0)

		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (1)'), 'passWord123', 0)
	}
