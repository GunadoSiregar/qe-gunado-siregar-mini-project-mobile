...
Mobile.setText(findTestObject('Object Repository/Logout/android.widget.EditText - Email (1)'), 'radengunado@gmail.com', 
    0)

Mobile.tap(findTestObject('Object Repository/Logout/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Object Repository/Logout/android.widget.EditText - Password (1)'), 'passWord123', 0)
